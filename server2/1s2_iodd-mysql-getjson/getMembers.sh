...
# mysqlsh -u root -pFormR\!1234 --json=raw    --database=io --js  -f getMembers.sjs
  ...
  mysqlsh -u root -pFormR\!1234 --json=pretty --database=io --sql  --execute "SELECT * FROM projects"
  mysqlsh -u root -pFormR\!1234 --json=pretty --database=io --sql  --execute "SELECT * FROM members_projects"
